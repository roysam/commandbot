...
resource "aws_s3_bucket" "data_log_bucket_destination" {
...
resource "aws_iam_role" "data_log_bucket_replication" {
  name = "aws-iam-role"
...
resource "aws_s3_bucket_replication_configuration" "data_log_bucket" {
  ...
  role   = aws_iam_role.data_log_bucket_replication.arn
  bucket = aws_s3_bucket.data_log_bucket.id
  rule {
    id = "foobar"
    status = "Enabled"
    destination {
      bucket        = aws_s3_bucket.data_log_bucket_destination.arn
